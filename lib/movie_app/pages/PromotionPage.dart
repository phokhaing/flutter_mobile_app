...
class _PromotionPageState extends State<PromotionPage> {
  ...
  Widget _gridViewExtent() {
    return GridView.extent(
      ...
      // max size of each items
      crossAxisSpacing: 5,
      // space x between each items
      mainAxisSpacing: 5,
      // space y between each items
      childAspectRatio: 9 / 16,
      // size width/height of each items.
      children: [
        Container(
  ...
  Widget _gridViewBuilder() {
    return GridView.builder(
      ...
      // use this, while scroll this blog It can cover ProfilePanel blog
      shrinkWrap: true,
      // use this to show this blog
